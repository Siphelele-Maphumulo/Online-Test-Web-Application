...
<style>
  /* Enhanced Student Results Page Styles */
  .results-wrapper {
    display: flex;
    min-height: 100vh;
    background: #f6f7fb;
...
<div class="results-wrapper">
  ...
  <div class="sidebar">
    <div class="sidebar-background">
      ...
      <div class="left-menu">
        ...
        <a class="active" href="std-page.jsp?pgprt=2">
  ...
  <div class="content-area">
    <div class="results-panel">
      ...
      %>
        ...
        <div class="results-summary">
          ...
          <%
            int passedExams = 0;
            for (Exams exam : list) {
              if (exam.getStatus() != null && exam.getStatus().equals("Pass")) {
                passedExams++;
              }
            }
          %>
          ...
          <%
            ...
            if (totalResults > 0) {
              ...
              for (Exams exam : list) {
                if (exam.gettMarks() > 0) {
                  totalPercentage += (double) exam.getObtMarks() / exam.gettMarks() * 100;
                }
              }
              ...
              <tbody id="courseTable">
                ...
                <%
                    ...
                    for (int i = 0; i < list.size(); i++) {
                      ...
                      String statusClass = "status-terminated";
                      String statusText = "Terminated";
                      if (e.getStatus() != null) {
                        statusClass = e.getStatus().equals("Pass") ? "status-pass" : "status-fail";
      ...
      %>
        <!-- Details View -->
        <a href="std-page.jsp?pgprt=2" class="back-btn">
        ...
        <div class="results-card">
          ...
          <div style="padding: 32px;">
            <table class="details-table">
              <%
                ArrayList<Answers> answersList = pDAO.getAllAnswersByExamId(Integer.parseInt(request.getParameter("eid")));
              ...
              <div style="background: #f8f9fa; padding: 20px; border-radius: 12px; margin-bottom: 24px;">
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 16px; text-align: center;">
                  <div>
                    <div style="font-size: 1.5rem; font-weight: 700; color: #09294D;"><%= answersList.size() %></div>
                    <div style="color: #6c757d; font-weight: 600;">Total Questions</div>
                  </div>
                  <div>
                    <div style="font-size: 1.5rem; font-weight: 700; color: #28a745;"><%= correctAnswers %></div>
                    <div style="color: #6c757d; font-weight: 600;">Correct Answers</div>
                  </div>
                  <div>
                    <div style="font-size: 1.5rem; font-weight: 700; color: #dc3545;"><%= answersList.size() - correctAnswers %></div>
                    <div style="color: #6c757d; font-weight: 600;">Incorrect Answers</div>
                  </div>
                  <div>
                    <div style="font-size: 1.5rem; font-weight: 700; color: #17a2b8;"><%= String.format("%.0f", (double) correctAnswers / answersList.size() * 100) %>%</div>
                    <div style="color: #6c757d; font-weight: 600;">Accuracy Rate</div>
                  </div>
                </div>
              </div>

    class ProctoringSystem { 
            ...
            if (validFaces.length === 0) { 
                ...
                if (timeLost > this.FACE_LOST_THRESHOLD) { 
                    ...
                    if (detections.length > 0 && timeLost < 800) {
                        ...
                        // IMMEDIATELY stop countdown if it was active
        ...
        processFallbackDetection(videoElement) { 
            ...
            try { 
                ...
                // More lenient fallback detection - just check for any movement/changes
                if (this.lastFrame) { 
                    let diff = 0; 
                    let pixelCount = 0; 
                    ...
                    // If there's some movement, consider it as "face detected" for fallback
                    if (avgDiff > 15) {
                        this.lastFaceDetected = Date.now();
                        if (this.countdownActive) {
                        ...
                        // Minor movement - still update but less frequently

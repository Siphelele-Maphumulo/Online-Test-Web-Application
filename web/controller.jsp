...
try {
    ...
    if ("check_username".equalsIgnoreCase(pageParam)) {
        ...
        boolean isValid = myPackage.GeminiClient.isFacePhotoValid(faceImage, reason);
        ...
        boolean isValid = myPackage.GeminiClient.isIdPhotoValid(idImage, reason);
        ...
        boolean holdingId = myPackage.GeminiClient.isHoldingId(idImage, reason);

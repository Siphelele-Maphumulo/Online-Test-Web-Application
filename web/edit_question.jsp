    ...
    function validateAndSubmit(event) {
        ...
        if (qType === "TrueFalse") {
            ...
            if (new Set(opts).size !== opts.length) {
                ...
                if (correctValue && !normalizedOpts.includes(correctValue)) {
...
function updateZoneCorrectOptions() {
    const items = Array.from(
        document.querySelectorAll('#draggableItemsList > div')
    ).map(function (div) {
    ...
    document.querySelectorAll('.dnd-zone-correct').forEach(function (select) {

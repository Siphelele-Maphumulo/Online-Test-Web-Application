...
<style>
  /* Enhanced Student Profile Page Styles */
  .profile-wrapper {
    display: flex;
    min-height: 100vh;
    background: #f6f7fb;
          ...
          <div class="profile-header">
            ...
            <div class="user-info">
              ...
              <span class="user-role <%= userRoleClass %>">
                <i class="fas <%= user.getType().equalsIgnoreCase("admin") ? "fa-user-shield" : 
                                 user.getType().equalsIgnoreCase("lecture") ? "fa-chalkboard-teacher" : "fa-user-graduate" %>"></i>
                <%= userRoleDisplay %>
              </span>
            </div>
          </div>
...
%>
      ...
      <div class="profile-card">
        <div class="card-header">
          ...
          <i class="fas fa-user-cog" style="opacity: 0.8;"></i>
        </div>
        <div class="edit-form">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input type="text" name="contactno" value="<%= user.getContact() %>" 
                       class="form-input" placeholder="Enter contact number" required>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" name="address" value="<%= user.getAddress() %>" 
                       class="form-input" placeholder="Enter address" required>
              </div>
            </div>

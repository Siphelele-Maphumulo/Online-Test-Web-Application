          ...
          <div class="auth-card p-4 p-md-5">
            ...
            <form action="controller.jsp" method="POST" onsubmit="return validateForm();">
              ...
              <div class="form-row">
                ...
                <div class="col-12 col-md-6">
                  <label class="sr-only" for="uname">MUT Identity Number</label>
                  <div class="input-icon">
                    <i class="fas fa-id-badge"></i>
                    <input id="uname" type="text" name="uname" class="form-control" placeholder="MUT Identity Number" required/>
                  </div>

...
<style>
  /* Enhanced Lecture Accounts Page Styles */
  .accounts-wrapper {
    display: flex;
    min-height: 100vh;
    background: #f6f7fb;
  ...
  <div class="sidebar">
    <div class="sidebar-background">
      ...
      <div class="left-menu">
        ...
        <a class="active" href="adm-page.jsp?pgprt=6">
    ...
    <div class="accounts-panel">
      ...
      <div class="accounts-card">
        ...
        <div class="actions-bar">
          <a href="Lecture_signup.jsp" class="add-lecturer-btn">
            <i class="fas fa-plus-circle"></i>
            Add New Lecturer
          </a>
          
          <div class="search-container">
            <input type="text" id="lecturerSearch" class="search-input" placeholder="Search by Staff No, Name, or Email...">
        ...
        <div style="overflow-x: auto;">
          <table class="accounts-table">
            ...
            <tbody id="lecturerTableBody">
              ...
              %>
                <tr>
                  <td colspan="6" class="no-lecturers">
              ...
              <%
                  ...
                  for (User lecturer : lecturerList) {
                    String initials = lecturer.getFirstName().substring(0, 1) + lecturer.getLastName().substring(0, 1);
              %>
              <tr>
                <td>
                ...
                <td class="contact-info">
                  <i class="fas fa-envelope" style="color: #e3e3e3; margin-right: 8px;"></i>
                  <%= lecturer.getEmail() %>
                </td>
                <td class="contact-info">
                ...
                <td class="location-info">
                  ...
                  <%= lecturer.getCity() %>, <%= lecturer.getAddress() %>
                </td>
                <td>
...
<script>
  ...
  document.getElementById('lecturerSearch').onkeyup = function() {
    ...
    for (var i = 0; i < rows.length; i++) {
      ...
      if (cells.length > 0) {
        // Search in staff number, name, and email
        const staffNumber = cells[1].textContent.toLowerCase();
        const lecturerName = cells[0].textContent.toLowerCase();
        const email = cells[2].textContent.toLowerCase();
        
        if (staffNumber.includes(input) || lecturerName.includes(input) || email.includes(input)) {
          match = true;
        }

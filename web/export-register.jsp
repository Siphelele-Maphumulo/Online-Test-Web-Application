...
<!--                    <div class="filter-group">
                ...
                <div class="quick-filter-row">
                    ...
                    <a href="export-register.jsp" class="btn btn-success" style="margin-left: auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-danger btn-sm delete-btn" 
                                    data-record-id="<%= rs.getInt("register_id") %>"
                                    data-student-name="<%= rs.getString("first_name") + " " + rs.getString("last_name") %>"
    ...
    <div id="deleteRegisterModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to permanently delete the following exam register record? This action cannot be undone.</p>
                <div id="registerDetails">
                    <!-- Record details will be populated by JavaScript -->
                </div>
            </div>
            <div class="modal-footer">
                <form id="deleteRegisterForm" action="controller.jsp" method="post" style="display: flex; gap: 8px;">
                    <input type="hidden" name="page" value="exam-register">
                    <input type="hidden" name="operation" value="del">
                    <input type="hidden" name="register_id" id="deleteRecordId">
...
<script>
    ...
    const deleteModal = document.getElementById('deleteRegisterModal');
    const deleteRecordIdInput = document.getElementById('deleteRecordId');
    const registerDetailsDiv = document.getElementById('registerDetails');
    const confirmDeleteBtn = document.getElementById('confirmDeleteBtn');

    function openDeleteModal(recordId, studentName, courseName) {
        registerDetailsDiv.innerHTML = '<strong>Student:</strong> ' + studentName + '<br><strong>Course:</strong> ' + courseName;
    ...
    document.getElementById('deleteRegisterForm').addEventListener('submit', function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                openDeleteModal(recordId, studentName, courseName);
            });
        });
    });

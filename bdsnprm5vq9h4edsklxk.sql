...
--
-- Host: bdsnprm5vq9h4edsklxk-mysql.services.clever-cloud.com:3306
-- Generation Time: Jan 07, 2026 at 11:33 PM
...
(306, 171, 'What is the output of len([10,20,30])?', '3', '3', 'correct'),
(307, 171, 'What is the correct file extension for Python files?', '.py', '.py', 'correct'),
(308, 171, 'The âelifâ keyword is short for âelse ifâ.', 'True', 'True', 'correct'),
(309, 171, 'Which symbol is used for floor division in Python?', '//', '//', 'correct'),
(310, 171, 'Given the function do_the_mass(parameter), what does the following code print? the_list=[x for x in range(2,3)]; variable=-1; do_the_mass(the_list); print(the_list[0])', '1', '1', 'correct'),
(311, 171, 'What is the result of bool(0)?', 'False', 'False', 'correct'),
(312, 171, 'Which of these is a valid variable name in Python?', '_var', '_var', 'correct'),
(313, 171, 'What symbol is used to start a comment in Python?', '#', '#', 'correct'),
(314, 171, 'Which function returns the largest item in a list?', 'max()', 'max()', 'correct'),
(315, 171, 'In Python, indentation is used to:', 'Indicate code blocks', 'Indicate code blocks', 'correct'),
(316, 171, 'What will be the output of print(10 // 3)?', '3', '3', 'correct'),
(317, 171, 'Which method adds an item to the end of a list?', 'append()', 'append()', 'correct'),
(318, 171, 'What function is used to get user input from the console?', 'input()', 'input()', 'correct'),
(319, 171, 'Python uses indentation to define code blocks.', 'True', 'True', 'correct'),
(320, 171, 'Which line correctly adds Oliver Twistâs phone number 5551122333 to the dictionary phone_dir?', 'phone_dir = [', 'phone_dir[\"Oliver Twist\"] = \"5551122333\"', 'incorrect'),
(321, 171, 'Which of these data types is ordered and changeable?', 'tuple', 'list', 'incorrect'),
(322, 171, 'What function is used to display output to the screen?', 'print()', 'print()', 'correct'),
(323, 171, 'Which operator is used to check equality in Python?', '==', '==', 'correct'),
(324, 171, 'What data type is the result of 3 / 2 in Python 3?', 'float', 'float', 'correct'),
(325, 171, 'What will be printed by runner(model=', 'e', 'e', 'correct'),
(326, 172, 'What is the expected output of the following code?\r\n\r\ndef runner(brand, model=', 'e', 'The code raises an unhandled exception', 'incorrect'),
(327, 172, 'Arrange the code correctly to form a conditional instruction which guarantees that a certain statement is executed when the speed variable is less than 50.0.\r\n\r\nUse these Tools:\r\n\r\n:, <, >, speed, if, 50.0', 'if speed < 50.0 :', 'if speed < 50.0 :', 'correct'),
(328, 172, 'Build a line of code which asks the user for a float value and assigns it to the level variable.\r\n\r\nUse the Tools:\r\n=, ==, ), (, int, ', 'level = float (input ( ', 'level = float (input ( \"Enter a flight level\" ))', 'incorrect'),
(329, 172, 'Choose the correct answer which is align as the data types below:\r\n42, -6.62607015e-34, \'//\'\', False, ', 'INTEGER, FLOAT, STRING, BOOLEAN, STRING', 'INTEGER, FLOAT, STRING, BOOLEAN, STRING', 'correct'),
(330, 172, 'Which of the following function can be invoked with two arguments?\r\n\r\nA)\r\n  def kappa(level):\r\n      pass\r\n\r\n\r\nB)\r\n  def iota(level, size=0):\r\n      pass\r\n\r\nC)\r\n  def mu(None):\r\n      pass\r\n\r\nD)\r\n  def lamba():\r\n      pass\r\n              ', 'B', 'B', 'correct'),
(331, 172, 'What is the expected result of the following code?\r\ndef walk(down):\r\n    if down == 0:\r\n        return 0\r\n    return down + walk(down - 1)\r\n        \r\nprint(walk(3))', '6', '6', 'correct'),
(332, 172, 'Build a line of code which prints the values assigned to the width and height variable separated by a multiplication sign (*)\r\n\r\nGiven:\r\n       width, height = 100, 120\r\n\r\nuse these tools\r\n\r\ninput, (, ', 'print ( width, height, sep=', 'print ( width, height, sep=\"*\" )', 'incorrect'),
(333, 172, 'What is true about exceptions in Python?\r\n(select two answers)', 'According to python terminology, exceptions are raised.|Not more than one exception branch can be executed in one try-catch block.', 'According to python terminology, exceptions are raised.|Not more than one exception branch can be executed in one try-catch block.', 'correct'),
(334, 172, 'What is the expected out put of the following code?\r\n\r\nmenu = {', '9.50', '.45', 'incorrect'),
(335, 172, 'How many hashes (#) does the code output to the screen?\r\n\r\nfloor = 0\r\nwhile floor != 0:\r\n    floor -= 1\r\n    print(', '#', '#', 'correct'),
(336, 172, 'What is the expected output of the following code?\r\n\r\ncounter = 10 * 4 - 5\r\nif counter > 0:\r\n    print(', '**', '*', 'incorrect'),
(337, 172, 'What is the expected output of the following code? If the freeway speed is 120 and urban areas is 100.\r\n\r\nurban = 100\r\nspeed = 120\r\nwhile speed > 0:\r\n    speed -= 20\r\n    if speed == urban:\r\n       break\r\n    print(', '**', 'The code producers no output.', 'incorrect'),
(338, 172, 'What is the expected output of the following code?\r\npower = 1\r\nwhile power < 5:\r\n    power += 1\r\n    print(', 'The code producers Three at signs ( @@@ )', 'The code producers two at signs ( @@ )', 'incorrect'),
(339, 172, 'What is the expected result of running the following code?\r\n\r\ndef do_the_mass(parameter):\r\n    parameter[0] += variable\r\n    return parameter[0]\r\n\r\nthe_list = [x for x in range(2,3)]\r\nvariable = -1\r\ndo_the_mass(the_list)\r\nprint(the_list[0])\r\n', 'The code outputs 0.', 'The code outputs 1.', 'incorrect'),
(340, 172, 'A process in which the source code is translated into machine code in order to be executed later is called:', 'compilation', 'compilation', 'correct'),
(341, 172, 'Build a line of code which asks the user for a integer value and assigns it to the counter variable.Use the Tools:=, ==, ), (, int, ', 'counter = int (input ( ', 'counter = int (input ( ', 'correct'),
(342, 172, 'What is the expected output of the following code?\r\n\r\nspeed = 3\r\nwhile speed > 0:\r\n    speed += 2\r\n    if speed == 7:\r\n       break\r\n    print(', '*', '*', 'correct'),
(343, 172, 'A binary code consist of:', 'a sequence of bits which encodes machine instructions', 'a sequence of bits which encodes machine instructions', 'correct'),
(344, 172, 'What will happen when the user runs the following code?\r\n\r\ntotal = 0\r\nfor i in range(4):\r\n    if 2 * i < 4:\r\n        total += 1\r\n    else:\r\n        total += 1\r\nprint(total)', 'The code outputs 4.', 'The code outputs 4.', 'correct'),
(345, 172, 'A program which is used to transform source file into an executable binary file is called:', 'a compiler', 'a compiler', 'correct'),
(346, 176, 'How many hashes (#) does the code output to the screen?\r\n\r\nfloor = 0\r\nwhile floor != 0:\r\n    floor -= 1\r\n    print(', 'Zero (The code outputs nothing)', '#', 'incorrect'),
(347, 176, 'What is the expected out put of the following code?\r\n\r\nmenu = {', '9.50', '.45', 'incorrect'),
(348, 176, 'What is the expected result of the following code?\r\n\r\ndef velocity(x):\r\n    return speed * x\r\n\r\nspeed = 2\r\nnew_speed = velocity(2)\r\nnew_speed = velocity(speed)\r\nprint(new_speed)\r\n', '8', '4', 'incorrect'),
(349, 176, 'What is the expected output of the following code? If the freeway speed is 120 and urban areas is 100.\r\n\r\nurban = 100\r\nspeed = 120\r\nwhile speed > 0:\r\n    speed -= 20\r\n    if speed == urban:\r\n       break\r\n    print(', '***', 'The code producers no output.', 'incorrect'),
(350, 176, 'Assuming that the phone_dir dictionary contains name: number pairs, choose the code arranged correctly to create a valid line of code which adds John Wick\'s phone number (5551122333) to the directory.\r\n\r\nUse these tools:\r\n\r\n] , =, ', 'phone_dir = [ ', 'phone_dir [ \"John Wick\" ] = \"5551122333\"', 'incorrect'),
(351, 176, 'What is the expected output of the following code?\r\n\r\ncollection = []\r\ncollection.insert(0, 2)\r\ncollection.append(3)\r\nduplicate = collection\r\nduplicate.append(2)\r\nprint(collection[-1] + duplicate[-1])', '5', '4', 'incorrect'),
(352, 176, 'Which of the following function can be invoked with two arguments?\r\n\r\nA)\r\n  def kappa(level):\r\n      pass\r\n\r\n\r\nB)\r\n  def iota(level, size=0):\r\n      pass\r\n\r\nC)\r\n  def mu(None):\r\n      pass\r\n\r\nD)\r\n  def lamba():\r\n      pass\r\n              ', 'N/A', 'B', 'incorrect'),
(353, 176, 'A program written in a high-level programing language is called:', 'N/A', 'a source code', 'incorrect'),
(354, 176, 'Arrange the code correctly to form a conditional instruction which guarantees that a certain statement is executed when the speed variable is less than 50.0.\r\n\r\nUse these Tools:\r\n\r\n:, <, >, speed, if, 50.0', 'N/A', 'if speed < 50.0 :', 'incorrect'),
(355, 176, 'What is the expected result of the following code?\r\ndef walk(down):\r\n    if down == 0:\r\n        return 0\r\n    return down + walk(down - 1)\r\n        \r\nprint(walk(3))', 'N/A', '6', 'incorrect'),
(356, 176, 'Which is the correct order which reflects their priority, where the left-most position has the highest priority and the right has the lowest priority.', 'N/A', '*, +, -', 'incorrect'),
(357, 176, 'Which of the following Expressions evaluate to a non-zero result?\r\n(Select two answers)', '', '2 + -2 / 2 + 2|2 + 2 * 2 // 2', 'incorrect'),
(358, 176, 'Assuming that the following assignment has been successfully executed:\r\n\r\nthe_list = [\'list\',True, 3e0]\r\n\r\nWhich of the following expressions evaluate to True?', 'N/A', 'int(the_list[2]) == len(the_list)|the_list[1] in the_list', 'incorrect'),
(359, 176, 'What is the expected output of the following code?\r\n\r\ndef runner(brand, model=', 'N/A', 'The code raises an unhandled exception', 'incorrect'),
(360, 176, 'What is the expected output of the following code?\r\npower = 1\r\nwhile power < 5:\r\n    power += 1\r\n    print(', 'N/A', 'The code producers two at signs ( @@ )', 'incorrect'),
(361, 176, 'A process in which the source code is translated into machine code in order to be executed later is called:', 'N/A', 'compilation', 'incorrect'),
(362, 176, 'What happens when the user runs the following code?\r\n\r\nspeed = 2\r\nwhile speed < 0:\r\n    speed += 2\r\n    if speed == 5:\r\n       break\r\n    print(', 'N/A', '*', 'incorrect'),
(363, 176, 'Choose the correct answer which is align as the data types below:\r\n42, -6.62607015e-34, \'//\'\', False, ', 'N/A', 'INTEGER, FLOAT, STRING, BOOLEAN, STRING', 'incorrect'),
(364, 176, 'What is true about exceptions in Python?\r\n(select two answers)', '', 'According to python terminology, exceptions are raised.|Not more than one exception branch can be executed in one try-catch block.', 'incorrect'),
(365, 176, 'Build a line of code which asks the user for a float value and assigns it to the level variable.\r\n\r\nUse the Tools:\r\n=, ==, ), (, int, ', 'N/A', 'level = float (input ( \"Enter a flight level\" ))', 'incorrect'),
(366, 177, 'Which keyword is used to exit a loop prematurely?', 'break', 'break', 'correct'),
(367, 177, 'Which symbol is used for floor division in Python?', '//', '//', 'correct'),
(368, 177, 'Python is a compiled language.', 'N/A', 'False', 'incorrect'),
(369, 177, 'Which code will print âOut of boundsâ when list index fails?', 'try: prices=[2.39,4.99,0.99]; selection=prices[3]; print(', 'try: prices=[2.39,4.99,0.99]; selection=prices[3]; print(\"Ok\") except IndexError: print(\"Out of bounds\")', 'incorrect'),
(370, 177, 'Which of these is used to create a comment in Python?', '#', '#', 'correct'),
(371, 177, 'Which function definitions correctly double the input? (Select two)', 'def times_2(x): return x + x|def double(value): return 2 * value', 'times_2, double', 'incorrect'),
(372, 177, 'What is the output of len([10,20,30])?', '3', '3', 'correct'),
(373, 177, 'What happens in this code? def velocity(x): return speed*x; speed=10; new_speed=velocity(10); new_speed=velocity(speed); print(new_speed)', '20', 'Error: variable not defined', 'incorrect'),
(374, 177, 'The keyword âelifâ stands for âelse ifâ.', 'True', 'True', 'correct'),
(375, 177, 'A tuple in Python can be modified after creation.', 'False', 'False', 'correct'),
(376, 177, 'What function is used to display output to the screen?', 'print()', 'print()', 'correct'),
(377, 177, 'What will be the output of print(10 // 3)?', '3', '3', 'correct'),
(378, 177, 'What keyword is used to handle exceptions?', 'catch', 'try', 'incorrect'),
(379, 177, 'Which loop is used when the number of iterations is unknown?', 'for', 'while', 'incorrect'),
(380, 177, 'Which keyword is used to create a class in Python?', 'object', 'class', 'incorrect'),
(381, 177, 'Assuming the assignment the_list = [', '300 in the_list and the_list[1]|the_list[1] in the_list', 'int(the_list[2]) == len(the_list), the_list.index(False) == 1', 'incorrect'),
(382, 177, 'Which of these functions can be called with two arguments?', 'def iota(level, size=0): pass', 'def iota(level, size=0): pass', 'correct'),
(383, 177, 'What does the len() function return?', 'The number of elements', 'The number of elements', 'correct'),
(384, 177, 'What function is used to get user input from the console?', 'input()', 'input()', 'correct'),
(385, 177, 'What will be printed by runner(model=', 'e', 'e', 'correct');
...
(168, '2', 'PECP 302 Exam', 30, NULL, '2025-10-31', '06:11', NULL, '30', NULL),
(169, '2', 'PECP 302 Exam', 30, NULL, '2025-10-31', '07:14', NULL, '30', NULL),
(170, '2', 'PECP 302 Exam', 30, NULL, '2025-11-06', '04:21', NULL, '30', NULL),
(171, '64', 'Python Entry Level', 10, 9, '2025-12-27', '13:32', '13:37', '30', 'Pass'),
(172, '64', 'PECP 302 Exam', 30, 18, '2025-12-27', '13:40', '13:49', '30', 'Pass'),
(173, '2', 'PECP 302 Exam', 30, NULL, '2025-12-27', '19:11:44.083821500', NULL, '30', NULL),
(174, '2', 'Python Entry Level', 10, NULL, '2025-12-27', '19:12:23.015565500', NULL, '30', NULL),
(175, '2', 'Python Entry Level', 10, NULL, '2025-12-28', '00:57:10.131526', NULL, '30', NULL),
(176, '2', 'PECP 302 Exam', 30, 0, '2025-12-28', '01:04:57.326908600', '01:05', '30', 'Fail'),
(177, '2', 'Python Entry Level', 10, 6, '2025-12-28', '01:06:13.315148800', '01:08', '30', 'Pass');
...
CREATE TABLE `staff` (
  ...
  `staffNum` varchar(6) COLLATE utf8mb4_general_ci NOT NULL,
  `FullNames` varchar(256) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(64, 'Siphelele', 'Maphumulo', '21229678', 'Siphelelemaphumulo@gmail.com', '$2a$10$T4OofkD/GUyDHtdwCXpDpO2YuVwsw4kUCaXDddvz4uUYf70.7E3jG', 'student', '0686764623', NULL, NULL),
(65, 'Siphelele', 'Maphumulo', '92112807', 'BaluKhawula@gmail.com', '$2a$10$PFCGf4KdVVCjxixNfsf10un0/rDhV2SongmVhhhNiyskhVY1XFYi.', 'student', '0609176724', NULL, NULL),
(67, 'Richard', 'Mfeka', '20012002', 'RichardMfeka@umlazicomtech.co.za', '$2a$10$cZYRWCB39OZCzHApSP0uqORf.8zegSBGtsNgFGNHm3bX.WgA3PdXG', 'student', '0311234567', NULL, NULL);
...
(64, 'Siphelele', 'Maphumulo', '21229678', 'Siphelelemaphumulo@gmail.com', '$2a$10$T4OofkD/GUyDHtdwCXpDpO2YuVwsw4kUCaXDddvz4uUYf70.7E3jG', 'student', '0686764623', 'Durban', 'Kwamashu L 856, Mathanda road'),
(65, 'Siphelele', 'Maphumulo', '92112807', 'BaluKhawula@gmail.com', '$2a$10$PFCGf4KdVVCjxixNfsf10un0/rDhV2SongmVhhhNiyskhVY1XFYi.', 'student', '0609176724', NULL, NULL),
(66, 'Mgqobi', 'Shezi', '11111111', 'MgqobiShezi@gmail.com', '$2a$10$f7GVxrGWj7nHYvn5WOEYS.0.5xpMERaJBAxQqddesr9xrsCLUj8H6', 'student', '0123456789', NULL, NULL),
(67, 'Richard', 'Mfeka', '20012002', 'RichardMfeka@umlazicomtech.co.za', '$2a$10$cZYRWCB39OZCzHApSP0uqORf.8zegSBGtsNgFGNHm3bX.WgA3PdXG', 'student', '0311234567', NULL, NULL);
...
--
ALTER TABLE `answers`
  MODIFY `answer_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=386;
...
--
ALTER TABLE `exams`
  MODIFY `exam_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;

--
-- AUTO_INCREMENT for table `questions`
--
ALTER TABLE `questions`
  MODIFY `question_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
